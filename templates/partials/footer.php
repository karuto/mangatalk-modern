	...
	<section class="footer__content maxwidth">
		<div class="footer__wrapper">
			<div class="footer__content__intro">
				...
				<p class="footer__content__intro__summary">没有资讯快餐，没有动游音影。我们致力于收集与输出中文互联网上最具长远留存价值的漫画内容，让你更了解漫画及其身后世界的魅力。<br/><br/><strong><a class="footer__content__intro__summary__link" href="/joinus">喜欢漫画的，都是我们的朋友。一起来玩吧！</strong></a></p>
			</div>
