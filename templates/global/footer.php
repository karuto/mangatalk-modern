<footer class="mt-footer content-info" role="contentinfo">
  <div class="container">
    ...
    <div class="row">
      <em class="signature text-muted">Design and Coded by Vincent Zhang in San Francisco. Copyright &copy; 2011-<?php echo date('Y'); ?> <?php bloginfo('name'); ?> & Our Authors. All Rights Reserved.</em>
