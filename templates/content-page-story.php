<?php
/*
 * Template Name: Full-width Page, story
 * Description: A Page Template with full-width, end-to-end display. Content is "Tell a story"
 */
?>
<div class="page-content page-fullwidth page-story">
  ...
  <div class="featurette-inner container">
    <div class="row">
      <div class="featurette-content col-md-12">
        <h2 class="featurette-heading">写一个好的故事</h2>
        <p class="lead">
           好的故事独一无二。她是你理解这个世界的折射。好的故事是对真理和正直的不懈追求，她基于事实，却高于现实。好的故事不拘足于牵强和妥协，她力求完美，正物之德，臻于至善。<br><br>

          好的故事寓教于乐。她生动有趣，却也育人教人，温故知新。她不会将带有偏见的立场强加于你，不会诱使你去改变你的原则与信条。好的故事是一位益友良师，她以谦逊平实的步调领你踏进一扇扇的门。她是一位信使，助你了解大千世界，了解你自己。<br><br>

          好的故事情真意切。她直白而真诚，与繁章复句、浮夸辞藻无关，她是你寄托着所有热爱的初心本心。若非如此，你又为何写作呢？好的故事不仅限于文字，她可以是一组图片、一部漫画、一个视频……但不变的，她是你与读者的一次坦率的交流。<br><br>

          好的故事阅毕后，或许会让你哭、让你笑、让你陷入沉思；但只要你觉得这一点阅读的时间没有虚度，她就在你的旅程上留下了一点小小的，哪怕只是小小的，有意义的足音。<br><br>
...
<section class="featurette feature-story-submit">
  <div class="featurette-inner container">
    <div class="row">
      <div class="featurette-content col-md-12">
        <h2 class="featurette-heading">漫言期待着你的故事</h2>
        <p class="lead">

           漫言致力于传播漫画媒介的艺术、文化与产业价值。我们希望你的故事，可以帮助读者们加深对漫画的理解与欣赏。<br><br>

           你的故事可以是关于某部具体的漫画作品、某位漫画界的人物、机构，或是将漫画相关的一段历史或一个现象、话题作为切入点。<br><br>

           你的故事应是未在别处发表过的、完全原创的非虚构作品。在选题上，你的故事应该做到精简、深入、自成一体，并应该是从只有你才能创作的独到角度出发。<br>
        </p>
      </div>
    </div><!-- .row -->
  </div><!-- .featurette-inner -->
    ...
    <div class="row">
      <div class="featurette-content col-md-12">
        ...
        <p class="lead">
           ...
           试稿一旦被选中，我们将会有专职的编辑与你进行联系，讨论具体的稿费、字数、截稿日期等细节。如果你出于个人原因，无法在约定时间内交稿，请提前至少一周告知责任编辑。<br><br>
